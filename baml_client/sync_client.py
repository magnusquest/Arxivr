...
class BamlSyncClient:
    ...
    def ReasoningAgent(
      ...
      return cast(List[types.Task], raw.cast_to(types, types))
...
class BamlStreamClient:
    ...
    def ReasoningAgent(
        ...
        message: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlSyncStream[List[partial_types.Task], List[types.Task]]:
      __tb__ = baml_options.get("tb", None)
      if __tb__ is not None:
        tb = __tb__._tb # type: ignore (we know how to use this private attribute)
      else:
      ...
      return baml_py.BamlSyncStream[List[partial_types.Task], List[types.Task]](
        raw,
        lambda x: cast(List[partial_types.Task], x.cast_to(types, partial_types)),
        lambda x: cast(List[types.Task], x.cast_to(types, types)),
        self.__ctx_manager.get(),
      )
